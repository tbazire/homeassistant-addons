...
#
# Static validation of the eebus_bridge_dev add-on config.yaml.
#
...
def main() -> int:
    ...
    print("Identity:")
    check(isinstance(cfg.get("slug"), str) and cfg["slug"] == "eebus_bridge_dev",
          f"slug is 'eebus_bridge_dev' (got {cfg.get('slug')!r})")

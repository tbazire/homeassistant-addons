...
func (h *heatpump) RemoteServiceConnected(service api.ServiceInterface, identity shipapi.ServiceIdentity) {
}

func (h *heatpump) RemoteServiceDisconnected(service api.ServiceInterface, identity shipapi.ServiceIdentity) {
}

func (h *heatpump) VisibleRemoteMdnsServicesUpdated(service api.ServiceInterface, entries []shipapi.RemoteMdnsService) {
}

func (h *heatpump) ServiceUpdated(identity shipapi.ServiceIdentity) {}

func (h *heatpump) ServicePairingDetailUpdate(identity shipapi.ServiceIdentity, detail *shipapi.ConnectionStateDetail) {
...
func (h *heatpump) AllowWaitingForTrust(identity shipapi.ServiceIdentity) bool {
	if len(config.remoteSKI) != 40 {
...
func (h *heatpump) ServiceAutoTrustFailed(service api.ServiceInterface, identity shipapi.ServiceIdentity, reason error) {
...
func (h *heatpump) ServiceAutoTrustRemoved(service api.ServiceInterface, identity shipapi.ServiceIdentity, reason string) {
	log.Printf("Auto Trust removed for identity %v: %v\n", identity.String(), reason)
}

// ServiceAutoTrusted implements api.ServiceReaderInterface.
func (h *heatpump) ServiceAutoTrusted(service api.ServiceInterface, identity shipapi.ServiceIdentity) {
